...
Describe the resulting plot -  is it unimodal?  How many peaks does it have?  Are all the peaks the same size? 
 ...
 It appears to me that the plot is not unimodel because it has 3 peaks but they are not the same size. The peak in the middle is the highest peak while the two next to it are the same size. 
